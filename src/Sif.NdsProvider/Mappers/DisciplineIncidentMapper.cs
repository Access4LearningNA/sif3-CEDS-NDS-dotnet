...
namespace Sif.NdsProvider.Mappers
{
    public class DisciplineIncidentMapper:Profile
    {
        ...
        public DisciplineIncidentMapper()
        {
            ...
            .ForMember(dest => dest.RefDisciplinaryActionTakenId, map => map.MapFrom(src => src.incidentActionList.Select(x => x.policeNotification.ToString() != null ? CommonMethods.GetCodesetCode("RefDisciplinaryActionTaken", "RefDisciplinaryActionTakenId", "Code", x.policeNotification.ToString()) : null)))
            ...
            .ForMember(dest => dest.RefIncidentTimeDescriptionCodeId, map => map.MapFrom(src => src.incidentTimeType.ToString() != null ? CommonMethods.GetCodesetCode("RefIncidentTimeDescriptionCode", "RefIncidentTimeDescriptionCodeId", "Code", src.incidentTimeType.ToString()) : null))
             ...
             .ForMember(dest=>dest.RefIncidentPerpetratorInjuryTypeId,map=>map.MapFrom(src=>src.offenderList.Select(x=>x.offenderInjury.ToString() !=null?CommonMethods.GetCodesetCode("RefIncidentPerpetratorInjuryType", "RefIncidentPerpetratorInjuryTypeId", "Code", x.offenderInjury.ToString()):null)))
