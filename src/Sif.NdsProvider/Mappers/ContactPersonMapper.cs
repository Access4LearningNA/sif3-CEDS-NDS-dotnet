...
namespace Sif.NdsProvider.Mappers
{
    public class ContactPersonMapper : Profile
    {
        ...
        {
            get { return "ContactPersonMapper"; }
        }
        public ContactPersonMapper()
        {
            CreateMap<ContactPerson, PersonDetail>()
            ...
            CreateMap<ContactPerson, PersonOtherName>()
            ...
            CreateMap<ContactPerson, PersonLanguage>()
            ...
            CreateMap<ContactPerson, PersonStatus>()
            ...
            CreateMap<ContactPerson, PersonBirthplace>()
            ...
            CreateMap<ContactPerson, PersonEmailAddress>()
            ...
            CreateMap<ContactPerson, PersonTelephone>()
